...
We thank Dmitry Vagner for interesting and useful conversations. We also thank Tobias Fritz for catching an error in a draft and for suggesting the strictification theorem (\cref{thm.supply_strictification}), which he had previously proven independently in a special case and shared with us; see \cite{fritz2019synthetic} forthcoming. We acknowledge support from AFOSR grants FA9550-17-1-0058 and FA9550-19-1-0113.
