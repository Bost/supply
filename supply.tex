...
\begin{definition} \label{def.semistrict}
  ...
  A \emph{semistrict} monoidal functor $F\colon \pp \to \cat{C}$ is a strong monoidal functor that sends any object $g_1 \otimes g_2 \otimes \dots \otimes g_n$ in $\pp$ to $(((I \otimes F(g_1)) \otimes F(g_2)) \otimes \dots ) \otimes F(g_n)$.
\end{definition}
