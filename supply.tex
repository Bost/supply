...
Let $\pp$ be a prop, $\cat{C}$ and $\cat{D}$ symmetric monoidal categories, and suppose $s$ is a supply of $\pp$ in $\cat{C}$ and $t$ is a supply of $\pp$ on $\cat{D}$. We say that a strong monoidal functor $(F,\varphi)\colon\cat{C}\to\cat{D}$ \emph{preserves the supply} if the diagram 
...
\todo{If $F$ preserves the supply, does it send homomorphisms to homomorphisms?}
...
$F\colon\cat{C}\to\cat{D}$ preserves the supply as in \cref{def.preserve_supply} iff there exists a natural isomorphism:
