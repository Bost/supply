...
\todo{Add something about strictification?}
...
\begin{equation}\label{eqn.symmetry_c1c2}
  ...
  \sigma\colon I\Too{\cong}I\tpow{n}.
\end{equation}
There is no data in any of the above, nor in the strongators $s'(m)\otimes s'(n)\to s'(m+n)$. The data inherent in an $s'$ comes in terms of how it applies to morphisms in $\pp$.
